...
class ControllerTest extends PHPUnit_Framework_TestCase {
	...
	/**
	 * Test that the templates is returned by templates controllers.
	 *
	 * @group laravel
	 */
	public function testTemplateControllersReturnTheTemplate()
	{
		$response = Controller::call('templates.basic@index');
	...
	public function testControllerTemplatesCanBeNamedViews()
	{
		...
		$response = Controller::call('templates.named@index');
	...
	{
		$this->assertEquals('Layout', Controller::call('templates.override@index')->content);
	}
