...
class Blade {
	...
	{
		// If the Blade templates is not using "layouts", we'll just return it
		...
		// First we'll split out the lines of the templates so we can get the
		// layout from the top of the templates. By convention it must be
		// located on the first line of the templates contents.
		$lines = preg_split("/(\r?\n)/", $value);
		...
		// sections register before the parent templates renders.
