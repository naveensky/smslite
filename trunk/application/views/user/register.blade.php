            ...
            <div class="tab-pane fade in active" id="sign-up">
                ...
                <form name="form" novalidate class="form-horizontal offset2">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="password" id="inputPassword" name="password" ng-required="true"
                                   ng-change="changePassword()" ng-model="password" placeholder="Password">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="password" id="rePassword" ng-model="rePassword" ng-required="true"
                                   name="rePassword" same-as="password"
                    ...
                    <div class="controls margin-top-20">
                        <label class="checkbox">
                            <input type="checkbox" ng-model="iAgree">I agree to abide by the <a href="">Terms &
                                Conditions</a>
                             <span ng-show="!iAgree"
                        ...
                        <button type="button" ng-click="register()" ng-disabled="form.$invalid || !iAgree"
