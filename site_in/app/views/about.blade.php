...
<div class="row">
    <div class="span4">
        <div class="page-main-icon page-about-icon">
            <i style="position: fixed;" class="icon-tint"></i>
        </div>
    </div>
    <div class="span8">
        <p>
        ...
        <ul class="list">
            ...
            <li>Plan for every size - Choose the package which suits your requirement.</li>
            <li>Online software which can be accessed from anywhere</li>

        </ul>
        </p>
        <h3>How our clients are using the service</h3>
